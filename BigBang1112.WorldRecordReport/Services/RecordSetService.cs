using BigBang1112.WorldRecordReport.Comparers;
using BigBang1112.WorldRecordReport.Converters.Json;
...
public class RecordSetService : IRecordSetService
{
    ...
    private static RecordSetDetailedRecordChanges? CompareTop10(RecordSet recordSet, RecordSet recordSetPrev)
    {
