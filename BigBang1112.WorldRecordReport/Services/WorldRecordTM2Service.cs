...
public class WorldRecordTM2Service : IWorldRecordTM2Service
{
    ...
    private readonly ILogger<WorldRecordTM2Service> _logger;
    ...
    public WorldRecordTM2Service(
        ILogger<WorldRecordTM2Service> logger,
        IWrRepo repo,
